<template>
  <div class="hot-search">
    <a-row style="margin: 0 -34px">
      <a-col style="padding: 0 34px; margin-bottom: 24px"
             :sm="12"
             :xs="24">
        <div class="num-info">
...
<script lang='ts'>
import MiniArea from "../chart/MiniArea.vue";
import { Row, Col, Icon, Table } from "ant-design-vue";
...
export default class HotSearch extends Vue {
  private searchData: any[] = searchData;
