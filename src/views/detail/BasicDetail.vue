<template>
  <page-layout title="基础详情页">
    <a-card :bordered="false">
      ...
      <a-table style="margin-bottom: 24px"
               :columns="goodsColumns"
               :dataSource="goodsData"
               :pagination="false">
      </a-table>
      <div class="title">退货进度</div>
      <a-table :columns="scheduleColumns"
...
import { Card, Divider, Table } from "ant-design-vue";
...
export default class BasicDetail extends Vue {
  private goodsColumns: any[] = goodsColumns;
  private goodsData: any[] = goodsData;
  private scheduleColumns: any[] = scheduleColumns;
  private scheduleData: any[] = scheduleData;
}
</script>
