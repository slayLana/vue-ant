...
@Component({
  name: "QueryList",
  components: {
    [StandardTable.name]: StandardTable,
    [Card.name]: Card,
    [Form.name]: Form,
...
export default class QueryList extends Vue {
  ...
  private onchange(selectedRowKeys: any, selectedRows: any) {
    this.selectedRowKeys = selectedRowKeys;
    this.selectedRows = selectedRows;
  }
  private remove() {
    this.dataSource = this.dataSource.filter(
      (item: any) => this.selectedRowKeys.indexOf(item.key) < 0
    );
