...
import { Layout, Row, Col, Card, Avatar, Button, List } from "ant-design-vue";

// 需要修改list-item.d.ts声明文件,第9行修改为:
// static Meta: typeof Meta;  typeof 用来判断变量类型
@Component({
  name: "WorkPlace",
  components: {
    [Radar.name]: Radar,
    [HeadInfo.name]: HeadInfo,
